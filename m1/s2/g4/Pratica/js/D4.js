...
let femaleCharacters = {name: 'Leia_Organa', hair_color: "brown", eye_color: "brown"};
...
let totaleMassa = 1100

if(totaleMassa < 500){
  console.log('Ship is under loaded');
}else if(totaleMassa == 500){
  console.log('Ship is half loaded');
}else if(totaleMassa > 700){
  if(totaleMassa > 700 && totaleMassa < 900){
    console.log('Warning: Load is over 700');
    }else if(totaleMassa > 900 && totaleMassa < 1000 ){
